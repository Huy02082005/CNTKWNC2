...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (brandFromURL) {
        const targetTab = document.querySelector(`.tab-btn[data-brand="${brandFromURL}"]`);
        ...
        const selectedBrand = activeTab ? activeTab.getAttribute('data-brand') : 'all';
